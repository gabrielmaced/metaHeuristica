...
#   fim_GRASP = time.time()
#   tempo_GRASP = fim_GRASP - inicio_grasp
#   print("\n")
#   pr.disable()
#   s = io.StringIO()
...
#   print(s.getvalue())
  ...
  with open('VNS_'+grammar_file, 'w') as f:
        # Substitui o print pelo write
        f.write(str(solucao_vns) + "\n")
        f.write("Cores " + str(qtde_cores_solucao_vns) + "\n\n\n\n\n\n\n")
        f.write(str(solucao_vns_annealing) + "\n")
        f.write("Cores " + str(qtde_cores_solucao_vns_annealing) + "\n")
